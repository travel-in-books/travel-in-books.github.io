...
description: رمان بدنام نوشته جی. ام. کوتزه — داستان استادی دانشگاه در آفریقای جنوبی که پس از رسوایی اخلاقی با پیامدهای دردناک روبرو می‌شود.
categories: [ادبیات داستانی,رمان]
tags: [آفریقای جنوبی,⭐⭐⭐⭐⭐⭐⭐☆☆☆ 7/10,۱۹۹۹,جی. ام. کوتزه,هویت,معاصر,سوم‌شخص محدود]
image:
  path: /assets/img/covers/Disgrace-By-John-Maxwell-Coetzee.webp
  alt: جلد کتاب بدنام از کوتزه
toc: true
---

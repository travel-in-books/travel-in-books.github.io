...
description: رمان جزئی از کل نوشته استیو تولتز — رمانی استرالیایی پرحجم و طنزآمیز درباره رابطه پدر و پسر، شکست، آرمان‌خواهی و سرنوشت خانوادگی.
categories: [ادبیات داستانی,رمان]
tags: [استرالیا,⭐⭐⭐⭐⭐⭐⭐☆☆☆ 7/10,۲۰۰۸,استیو تولتز,معاصر,خانواده,اول‌شخص,چندراوی,روایت تودرتو]
image:
  path: /assets/img/covers/A-fraction-of-the-whole-by-Steve-Toltz.webp
  alt: جلد کتاب جز از کل از استیو تولتز
toc: true
---

| نام اثر | جز از کل |
| نویسنده | استیو تولتز |
| نام اصلی اثر | A fraction of the whole by Steve Toltz  |
| سال چاپ | ۲۰۰۸ |
| کشور | استرالیا |

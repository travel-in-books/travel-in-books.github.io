...
description: رمان امریکانا نوشته چیماماندا انگوزی آدیچی — داستان دختری نیجریایی که به آمریکا مهاجرت می‌کند و با نژاد، هویت و عشقی ناتمام روبرو می‌شود.
categories: [ادبیات داستانی,رمان]
tags: [نیجریه,⭐⭐⭐⭐⭐⭐⭐☆☆☆ 7/10,۲۰۱۳,چیماماندا انگزی آدیچی,هویت,معاصر,سوم‌شخص محدود,روایت متناوب,چندراوی]
image:
  path: /assets/img/covers/Americanah-by-Chimamanda-Ngozi-Adichie.webp
  alt: جلد کتاب امریکانا از چیماماندا انگزی آدیچی
toc: true
---

| نام اثر | امریکانا |
| نویسنده | چیماماندا انگزی آدیچی |
| نام اصلی اثر | Americanah by Chimamanda Ngozi Adichie |
| سال چاپ | ۲۰۱۳  |
| کشور | نیجریه  |
| ژانر | رمان   |
...
کایوده - محبوب‌ترین دانش‌آموز دبیرستان ایفملو. او می‌خواهد اوبینزه را با جینیکا آشنا کند

امنیکه - یکی از دوستان دانشگاه اوبینزه که با افزایش ثروتش، به فردی سلطه‌جو تبدیل می‌شود

ژنرال - مردی مهم در دولت نظامی نیجریه که با عمه اوجو رابطه دارد. او به شدت کنترل‌گر است و زندگی عمه اوجو را طوری تنظیم می‌کند که او کاملاً به او وابسته باشد. او همچنین پدر دایک است.

کیمبرلی - یک زن سفیدپوست خوش‌قلب اما ممتاز که به ایفملو پیشنهاد کار پرستاری از کودک در آمریکا را می‌دهد. «احساس گناه سفیدپوستی» کیمبرلی باعث می‌شود که او مدام عذرخواهی کند، که در ابتدا دوستی با ایفملو را برای او دشوار می‌کند

لارا - خواهر کیمبرلی، یک زن سفیدپوست سخت‌گیر و تلخ‌مزاج. او در زندگی کیمبرلی دخالت می‌کند و حتی او را از استخدام ایفملو منصرف می‌کند

مورگان - دختر بدخلق کیمبرلی

تیلور - پسر کیمبرلی

کورت - پسرعموی کیمبرلی، مرد سفیدپوست ثروتمندی پر از انرژی و خوش‌بینی است که با ایفملو قرار می‌گذارد. او از دادن هدایای گران‌قیمت به ایفملو و بردن او به مقاصد عجیب و غریب لذت می‌برد، حتی مطمئن می‌شود که او پس از فارغ‌التحصیلی می‌تواند شغلی پیدا کند. با این حال، کرت نسبت به ایفملو حس مالکیت دارد و قادر به درک کامل او نیست

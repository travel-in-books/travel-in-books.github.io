...
description: رمان دختری که پادشاه سوئد را نجات داد نوشته یوناس یوناسون — رمانی طنزآمیز و خواندنی از سوئد درباره تصادف‌های خنده‌دار و ماجراجویی‌های پیش‌بینی‌نشده.
categories: [ادبیات داستانی,رمان]
tags: [سوئد,⭐⭐⭐☆☆☆☆☆☆☆ 3/10,۲۰۱۳,یوناس یوناسون,طنز,معاصر,دانای کل]
image:
  path: /assets/img/covers/The-girl-who-saved-the-sweden-king-by-Jonas-Jonasson.webp
  alt: جلد کتاب دختری که پادشاه سوئد را نجات داد از یوناس یوناسون
toc: true
---

| نام اثر | دختری که پادشاه سوئد را نجات داد |
| نویسنده | یوناس یوناسون |
| نام اصلی اثر | The girl who saved the sweden king by Jonas Jonasson  |
| سال چاپ | ۲۰۱۳ |
| کشور | سوئد |
| ژانر | رمان طنز اجتماعی |
| تعداد صفحات | حدود ۴۳۰ صفحه |
| امتیاز | {% include rating.html score=3 %} |

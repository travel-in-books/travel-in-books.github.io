...
description: رمان بامگارتنر نوشته پل اوستر — آخرین رمان اوستر؛ داستان پیرمردی که با خاطرات همسر فقیدش زندگی می‌کند و با پیری و تنهایی روبروست.
categories: [ادبیات داستانی,رمان]
tags: [آمریکا,⭐⭐⭐⭐⭐⭐⭐☆☆☆ 7/10,۲۰۲۳,پل استر,معاصر,مرگ,سوم‌شخص محدود]
image:
  path: /assets/img/covers/Baumgartner-by-Paul-Auster.webp
  alt: جلد کتاب بامگارتنر از پل استر
toc: true
---

| نام اثر | بامگارتنر |
| نویسنده | پل استر |
| نام اصلی اثر | Baumgartner by Paul Auster  |
| سال چاپ | ۲۰۲۳  |
| کشور | آمریکا  |
| ژانر | رمان   |

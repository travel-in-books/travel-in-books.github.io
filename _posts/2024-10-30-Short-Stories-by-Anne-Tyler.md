...
description: نقد و معرفی داستان‌های کوتاه آن تایلر — داستان‌هایی درباره زندگی خانوادگی آمریکایی با دقتی موشکافانه به روابط انسانی و لحظه‌های تغییرساز.
categories: [ادبیات داستانی,داستان کوتاه]
tags: [آمریکا,داستان کوتاه,⭐⭐⭐⭐⭐⭐⭐☆☆☆ 7/10,۰۰۰۰,آن تایلر,رئالیسم,خانواده,سوم‌شخص محدود]
image:
  path: /assets/img/covers/Short-Stories-by-Anne-Tyler.webp
  alt: جلد کتاب داستان‌ کوتاه‌هایی از آن تایلر
toc: true
---

| نام اثر | مجموعه داستان‌ کوتاه‌ |
| نویسنده | آن تایلر |
| نام اصلی اثر | Short Stories by Anne Tyler  |
| سال چاپ | ۰۰۰۰ |
| کشور | آمریکا |
| ژانر | ادبی |

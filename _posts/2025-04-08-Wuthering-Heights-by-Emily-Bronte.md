...
description: رمان بلندی‌های بادگیر نوشته امیلی برونته — داستان عشق طوفانی هیثکلیف و کاترین در دل طبیعت وحشی انگلستان. کلاسیک ادبیات گوتیک.
categories: [ادبیات داستانی,رمان]
tags: [انگلیس,⭐⭐⭐⭐⭐⭐⭐⭐☆☆ 8/10,۱۸۴۷,امیلی برونته,کلاسیک,عشق,اول‌شخص,روایت تودرتو,چندراوی]
image:
  path: /assets/img/covers/Wuthering-Heights-by-Emily-Bronte.webp
  alt: جلد کتاب بلندی‌های بادگیر از امیلی برونته
toc: true
---

| نام اثر | بلندی‌های بادگیر |
| نویسنده | امیلی برونته |
| نام اصلی اثر | Wuthering Heights by Emily Bronte  |
| سال چاپ | ۱۸۴۷ |
| کشور | انگلیس |
| ژانر | رمان ادبی |

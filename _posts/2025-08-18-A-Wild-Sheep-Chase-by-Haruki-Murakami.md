...
tags: [ژاپن,⭐⭐⭐⭐⭐⭐⭐⭐☆☆ 8/10,۱۹۸۲,هاروکی موراکامی,فراواقع‌گرا,هویت,گوش,ماوراءطبیعی,فلاش‌بک تاریخی,شرور بی‌چهره,زن مرموز,ناپدیدشدن,تعقیب,گربه,جاز,اسم غیرعادی,اول‌شخص]
image:
...
| نام اصلی اثر | A Wild Sheep Chase by Haruki Murakami  |
| سال چاپ | ۱۹۸۲ |
| کشور | ژاپن |
| ژانر | رمان اجتماعی |
...
گرنت اسنایدر در «بینگوی هاروکی موراکامی» بیست‌وچهار مضمونی را که موراکامی بارها و بارها به آن‌ها برمی‌گردد در یک کارت جمع کرده است. از این بیست‌وچهار خانه، این‌ها در «تعقیب گوسفند وحشی» پر می‌شوند:

![بینگوی هاروکی موراکامی، اثر گرنت اسنایدر](/assets/img/misc/murakami-bingo.webp)

- **شیفتگی به گوش** — دوست‌دختر راوی و گوش‌هایی که تمام قدرتش در آن‌هاست
- **زن مرموز** — همان دختر، که هیچ‌وقت اسمی پیدا نمی‌کند
- **ناپدیدشدن چیزی** — اول دختر، بعد «موش»
- **حس تعقیب‌شدن** — منشی سیاه‌پوش رئیس
- **تماس تلفنی غیرمنتظره**
- **گربه‌ها** — گربه‌ای که راوی به راننده می‌سپارد
- **صفحه‌ی قدیمی جاز** — بار جِی
- **ملال شهری**
- **قدرت‌های ماوراءطبیعی** — حلول گوسفند و مرد گوسفندی
- **ایستگاه قطار** — سفر طولانی به شمال و هوکایدو
- **فلاش‌بک تاریخی** — تاریخ آبادانی جونی‌تاکی و گذشته‌ی منچوریِ رئیس
- **آشپزی** — غذاپختن‌های تنهای راوی
- **شرور بی‌چهره** — رئیس، که هرگز دیده نمی‌شود
- **اسم غیرعادی** — «موش»، «جِی»، «مرد گوسفندی» و راویِ بی‌نام
- **توکیو در شب**

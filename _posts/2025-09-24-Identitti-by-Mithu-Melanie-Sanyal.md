...
description: رمان آیدنتیتی نوشته میتو ملانی سانیال — رمانی آلمانی درباره بحران هویت نژادی، پست‌کلونیالیسم و دنیای آکادمیک.
categories: [ادبیات داستانی,رمان]
tags: [آلمان,⭐⭐⭐⭐⭐⭐⭐⭐☆☆ 8/10,۲۰۲۱,میتو سانیال,هویت,معاصر,سوم‌شخص محدود,روایت تودرتو]
image:
  path: /assets/img/covers/Identitti-by-Mithu-Melanie-Sanyal.webp
  alt: جلد کتاب آیدنتیتی از میتو سانیال
toc: true
---

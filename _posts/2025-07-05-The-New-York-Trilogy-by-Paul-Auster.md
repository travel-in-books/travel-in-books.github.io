...
description: سه‌گانه نیویورک نوشته پل اوستر — سه داستان کارآگاهی پست‌مدرن درباره هویت، زبان و معنا؛ جایی که مرز میان کارآگاه و تحقیق‌شونده محو می‌شود.
categories: [ادبیات داستانی,رمان]
tags: [آمریکا,⭐⭐⭐⭐⭐⭐⭐☆☆☆ 7/10,۱۹۸۷,پل استر,پست‌مدرنیسم,هویت,سوم‌شخص محدود,اول‌شخص,روایت تودرتو]
image:
  path: /assets/img/covers/The-New-York-Trilogy-by-Paul-Auster.webp
  alt: جلد کتاب سه‌گانه‌ی نیویورک از پل استر
toc: true
---

| نام اثر | قلعه شیشه‌ای |
| نویسنده | پل استر |
| نام اصلی اثر | The New York Trilogy by Paul Auster  |
| سال چاپ | ۱۹۸۷  |
| کشور | آمریکا  |
| ژانر | رمان   |
...
[توضیح](https://www.reddit.com/r/books/comments/h14tte/my_theory_of_the_new_york_trilogy_by_paul_auster/)
فصل اول:

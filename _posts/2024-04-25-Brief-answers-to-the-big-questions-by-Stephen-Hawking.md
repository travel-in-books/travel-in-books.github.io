...
description: نقد و بررسی کتاب پاسخ‌های کوتاه به پرسش‌های بزرگ نوشته استیون هاوکینگ — دیدگاه‌های آخرین کتاب فیزیکدان بزرگ درباره خدا، هوش مصنوعی، فضا و آینده بشر.
categories: [ادبیات غیر‌داستانی,علمی]
tags: [انگلیس,علم,⭐⭐⭐⭐⭐⭐⭐☆☆☆ 7/10,۲۰۱۸,استفان هاوکینگ,فلسفی,معاصر]
image:
  path: /assets/img/covers/Brief-answers-to-the-big-questions-by-Stephen-Hawking.webp
  alt: جلد کتاب پاسخ‌های کوتاه به پرسش‌های بزرگ از استفان هاوکینگ
toc: true
---

| نام اثر | پاسخ‌های کوتاه به پرسش‌های بزرگ |
| نویسنده | استفان هاوکینگ |
| نام اصلی اثر | Brief answers to the big questions by Stephen Hawking  |
| سال چاپ | ۲۰۱۸ |
| کشور | انگلیس |
| ژانر | علمی |
...
<b id="f1">1</b> <span class="footnote">Brief answers to the big questions by Stephen Hawking</span>[↩](#a1)

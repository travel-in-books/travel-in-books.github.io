...
description: رمان آیلین نوشته اتسا مشفق — داستان دختری منزوی و ناراضی در دهه ۱۹۶۰ آمریکا که دست به یک عمل جنایی می‌زند؛ روان‌شناسی تاریک و جذاب.
categories: [ادبیات داستانی,رمان]
tags: [آمریکا,⭐⭐⭐⭐⭐⭐⭐⭐☆☆ 8/10,۲۰۱۵,آتوسا مشفق,هویت,معاصر,اول‌شخص,راوی غیرقابل‌اعتماد]
image:
  path: /assets/img/covers/Eileen-by-Ottessa-Moshfegh.webp
  alt: جلد کتاب آیلین از آتوسا مشفق
toc: true
---

| نام اثر | آیلین |
| نویسنده | آتوسا مشفق |
| نام اصلی اثر | Eileen by Ottessa Moshfegh  |
| سال چاپ | ۲۰۱۵ |
| کشور | آمریکا |
| ژانر | رمان ادبی |

...
description: رمان شرق بهشت نوشته جان استاین‌بک — حماسه‌ای درباره آزادی اراده و انتخاب اخلاقی با مفهوم «تیمشل» در دره سالیناس کالیفرنیا.
categories: [ادبیات داستانی,رمان ادبی]
tags: [آمریکا,⭐⭐⭐⭐⭐⭐⭐☆☆☆ 7/10,۱۹۵۲,جان استاین‌بک,رئالیسم,خانواده,دانای کل,اول‌شخص]
image:
  path: /assets/img/covers/East-of-Eden-by-John-Steinbeck.webp
  alt: جلد کتاب شرق بهشت از جان استاین‌بک
toc: true
quiz:
  - q: "مفهوم «تیمشل» در «شرق بهشت» به چه معناست؟"
    options: ["تو باید (اجبار اخلاقی)", "تو می‌توانی (آزادی انتخاب)", "تو نمی‌توانی (محدودیت)", "تو خواهی کرد (سرنوشت)"]
    answer: 1
  - q: "کتی ایمز (کیت) پس از ترک آدام و تیراندازی به او چه کاری می‌کند؟"
    options: ["به اروپا مهاجرت می‌کند", "به روستا برمی‌گردد", "کنترل یک فاحشه‌خانه را به دست می‌گیرد", "با مرد دیگری ازدواج می‌کند"]
    answer: 2
  - q: "لی، خدمتکار چینی-آمریکایی آدام، چه نقشی در خانواده تراسک دارد؟"
    options: ["فقط آشپز و خدمتکار خانه", "شخصیت فلسفی و پدرانه برای کل و آرون", "دشمن پنهان آدام", "جاسوس دولت"]
    answer: 1
  - q: "داستان خانواده‌های تراسک و همیلتون در کدام منطقه آمریکا اتفاق می‌افتد؟"
    options: ["تگزاس", "دره سالیناس، کالیفرنیا", "نیویورک", "ایلینوی"]
    answer: 1
---

| نام اثر | شرق بهشت  |
| نویسنده | جان استاین‌بک |
| نام اصلی اثر | East of Eden by John Steinbeck  |
| سال چاپ | ۱۹۵۲  |
| کشور | آمریکا |
| ژانر | رمان ادبی |

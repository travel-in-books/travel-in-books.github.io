...
description: رمان لویاتان نوشته پل اوستر — داستان نویسنده‌ای که رازهای دوستش را پس از مرگ بازسازی می‌کند؛ رمانی درباره هویت، ایده‌آلیسم و خشونت سیاسی.
categories: [ادبیات داستانی,رمان]
tags: [آمریکا,⭐⭐⭐⭐⭐⭐⭐☆☆☆ 7/10,۱۹۹۲,پل استر,پست‌مدرنیسم,هویت,اول‌شخص,روایت تودرتو]
image:
  path: /assets/img/covers/Leviathan-by-Paul-Auster.webp
  alt: جلد کتاب لویاتان از پل استر
toc: true
---

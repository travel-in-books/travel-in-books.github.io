...
description: رمان حرام‌زاده استانبول نوشته الیف شافاک — داستان دو خانواده ترک و ارمنی‌آمریکایی که هویت، تاریخ و فاجعه نسل‌کشی را کنار هم می‌نشانند.
categories: [ادبیات داستانی,رمان]
tags: [ترکیه,⭐⭐⭐⭐⭐⭐⭐☆☆☆ 7/10,۲۰۰۶,الیف شافاک,هویت,خانواده,دانای کل,چندراوی]
image:
  path: /assets/img/covers/The-Bastard-of-Istanbul-by-Elif-Shafak.webp
  alt: جلد کتاب حرام‌زاده استانبول از الیف شافاک
toc: true
---

| نام اثر | حرام‌زاده استابنول |
| نویسنده | الیف شافاک |
| نام اصلی اثر | The Bastard of Istanbul by Elif Shafak  |
| سال چاپ | ۲۰۰۶  |
| کشور | ترکیه  |
| ژانر | رمان ادبی  |

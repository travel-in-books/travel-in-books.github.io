...
description: نقد و معرفی داستان‌های کوتاه ویلیام فاکنر — آثاری از برنده نوبل ادبیات درباره جنوب آمریکا، تاریخ، نژاد و روان پیچیده انسان.
categories: [ادبیات داستانی,داستان کوتاه]
tags: [آمریکا,داستان کوتاه,⭐⭐⭐⭐⭐⭐⭐☆☆☆ 7/10,۱۹۳۰,ویلیام فاکنر,مدرنیسم,جریان سیال ذهن,اول‌شخص,سوم‌شخص محدود]
image:
  path: /assets/img/covers/Short-Stories-by-William-Faulkner.webp
  alt: جلد کتاب داستان‌ کوتاه‌هایی از ویلیام فاکنر
toc: true
---

| نام اثر | داستان‌ کوتاه‌هایی |
| نویسنده | ویلیام فاکنر |
| نام اصلی اثر | Short Stories by William Faulkner  |
| سال چاپ | ۱۹۳۰ |
| کشور | آمریکا |
| ژانر | رمان ادبی |

...
tags: [ژاپن,⭐⭐⭐⭐⭐⭐⭐⭐☆☆ 8/10,۱۹۹۴,هاروکی موراکامی,فراواقع‌گرا,هویت,چاه,گربه,جهان موازی,فلاش‌بک تاریخی,زن مرموز,ماوراءطبیعی,گذرگاه مخفی,شرور بی‌چهره,ناپدیدشدن,تعقیب,تلفن,اسم غیرعادی,اول‌شخص,روایت تودرتو]
image:
...
| نام اصلی اثر | The Wind Up Bird Chronicle by Haruki Murakami  |
| سال چاپ | ۱۹۹۴ و ۱۹۹۵  |
| کشور | ژاپن  |
| ژانر | فانتزی کم   |
...
شخصیت‌ها به انگلیسی<sup id="a2">[2](#f2)</sup>

- تورو اوکادا: شخصیت اصلی داستان که یک مرد بیکار و در جستجوی همسر گمشده خود است.
- کومیکو اوکادا: همسر تورو که ناپدید می‌شود و نقش مهمی در جستجوی تورو دارد.
- مالتا کانوا: یک زن مرموز که به تورو کمک می‌کند تا همسرش را پیدا کند.
- کرتا کانوا: خواهر مالتا، که تجربه‌های عجیب و غیرمعمولی دارد و در تلاش برای کمک به تورو است.
- نوبورو واتایا<: برادر کومیکو که یک شخصیت سیاسی مهم و دشمن تورو است. همچنین تورو و کومیکو اسم گربه خود را همین اسم گذاشته‌اند.
- مای کاشاهارا: یک دختر نوجوان که با تورو دوست می‌شود و به او کمک می‌کند تا معانی جدیدی از زندگی پیدا کند.
- ستوان مامیا: یک سرباز سابق که داستان‌های جنگی‌اش تأثیر عمیقی بر تورو دارد.
- ناتمگ آکاساکا: یک زن مرموز که با تورو در تماس است و در یک خانه مد فعالیت می‌کند.
- سینمان آکاساکا: پسر نوتاکو که یک شخصیت ساکت و مرموز است.
- آقای هوندا: یک دوست قدیمی خانواده اوکادا که دانش و حکمت زیادی دارد.
...
<b id="f1">1</b><span class="footnote">The Wind Up Bird Chronicle by Haruki Murakami</span>[↩](#a1)
...
گرنت اسنایدر در «بینگوی هاروکی موراکامی» بیست‌وچهار مضمونی را که موراکامی بارها و بارها به آن‌ها برمی‌گردد در یک کارت جمع کرده است. از این بیست‌وچهار خانه، این‌ها در «تاریخچه‌ی پرنده‌ی کوکی» پر می‌شوند:

![بینگوی هاروکی موراکامی، اثر گرنت اسنایدر](/assets/img/misc/murakami-bingo.webp)

- **چاه خشک** — مشهورترین چاه موراکامی؛ تورو ته آن می‌نشیند و از آنجا وارد جای دیگری می‌شود
- **گربه‌های ناپدیدشده** — گم‌شدن گربه، که همه‌چیز از آن شروع می‌شود
- **گربه‌ها** — گربه‌ای به اسم نوبورو واتایا
- **تماس تلفنی غیرمنتظره** — تماس ناشناس زن در همان صفحه‌های اول
- **ناپدیدشدن چیزی** — بعد از گربه، نوبت کومیکو است
- **حس تعقیب‌شدن**
- **زن مرموز** — مالتا و کرتا کانو، جوز هندی
- **قدرت‌های ماوراءطبیعی**
- **گذرگاه مخفی** — چاه، که به اتاق ۲۰۸ هتل باز می‌شود
- **جهان‌های موازی**
- **فلاش‌بک تاریخی** — بزرگ‌ترین نمونه در کل آثار موراکامی: نومونهان و منچوری در روایت ستوان مامیا
- **نوجوان زودرس** — می کاساهارا
- **آشپزی** — اسپاگتی‌پختن در صفحه‌ی اول
- **رابطه‌ی جنسی عجیب** — خواب‌های کرتا کانو
- **اسم غیرعادی** — مالتا، کرتا، جوز هندی و دارچین
- **شرور بی‌چهره** — نوبورو واتایا و مرد پوست‌کن
- **ملال شهری** — بیکاری و بی‌کارگی تورو
- **ایستگاه قطار**
- **صفحه‌ی قدیمی جاز** — با این تفاوت که موسیقی افتتاحیه‌ی کتاب «کلاغ دزد» روسینی است
- **توکیو در شب**

(۲۰ خانه از ۲۴ خانه — پرشده‌ترین کارت میان کتاب‌های موراکامی این سایت)

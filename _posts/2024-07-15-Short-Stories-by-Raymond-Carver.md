...
description: نقد و معرفی داستان‌های کوتاه ریموند کارور — استاد رئالیسم کمینه‌گرا؛ داستان‌هایی ساده و تکان‌دهنده درباره زندگی طبقه کارگر آمریکا.
categories: [ادبیات داستانی,داستان کوتاه]
tags: [آمریکا,داستان کوتاه,⭐⭐⭐⭐⭐⭐⭐☆☆☆ 7/10,۱۹۸۱,ریموند کارور,رئالیسم,معاصر,اول‌شخص,سوم‌شخص محدود]
image:
  path: /assets/img/covers/Short-Stories-by-Raymond-Carver.webp
  alt: جلد کتاب داستان‌ کوتاه‌هایی از ریموند کارور
toc: true
---
...
| نام اصلی اثر | Short Stories by Raymond Carver  |
| سال چاپ | ۱۹۸۱ |
| کشور | آمریکا |
| ژانر | رمان اجتماعی |
